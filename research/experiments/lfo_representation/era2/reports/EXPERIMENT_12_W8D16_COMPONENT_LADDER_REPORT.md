...
This family asks whether the decoder should keep a wider path beam while choosing atom sequences. The per-family plots show `Beam8Path` buys a small P95 improvement over `Beam4Path`, but the diagnostic panel shows the expected encoding-time cost. It is worth keeping both only if Experiment 13 can afford the extra rows.

![Path Search Policy co-primary metrics](./images/experiment_12/experiment12_path_search_policy_co_primary.png)

![Path Search Policy runtime and diagnostics](./images/experiment_12/experiment12_path_search_policy_diagnostics.png)
...
![Construction Policy co-primary metrics](./images/experiment_12/experiment12_construction_policy_co_primary.png)

![Construction Policy runtime and diagnostics](./images/experiment_12/experiment12_construction_policy_diagnostics.png)

### Utility Candidate Budget

This family tests how many candidate residuals the offline construction policy considers before choosing a repair atom. The plots show diminishing returns rather than a clean monotonic curve. `CandidateBudget48` is the best quality candidate under `PhaseAndResidualGain`, but `CandidateBudget24` and `CandidateBudget12` remain useful cost controls.

![Utility Candidate Budget co-primary metrics](./images/experiment_12/experiment12_utility_candidate_budget_co_primary.png)

![Utility Candidate Budget runtime and diagnostics](./images/experiment_12/experiment12_utility_candidate_budget_diagnostics.png)
...
![Layer Normalization Policy co-primary metrics](./images/experiment_12/experiment12_layer_normalization_policy_co_primary.png)

![Layer Normalization Policy runtime and diagnostics](./images/experiment_12/experiment12_layer_normalization_policy_diagnostics.png)

### No Damage Policy

This family tests whether late layers should be prevented from making an already-good reconstruction worse. The family plots are mostly flat, which means the required `NoOpAtom` already handles much of the safety behavior. Keep this axis small in Experiment 13.

![No Damage Policy co-primary metrics](./images/experiment_12/experiment12_no_damage_policy_co_primary.png)

![No Damage Policy runtime and diagnostics](./images/experiment_12/experiment12_no_damage_policy_diagnostics.png)
...
![Atom Preprocessing Policy co-primary metrics](./images/experiment_12/experiment12_atom_preprocessing_policy_co_primary.png)

![Atom Preprocessing Policy runtime and diagnostics](./images/experiment_12/experiment12_atom_preprocessing_policy_diagnostics.png)
...
![Duplicate Suppression Policy co-primary metrics](./images/experiment_12/experiment12_duplicate_suppression_policy_co_primary.png)

![Duplicate Suppression Policy runtime and diagnostics](./images/experiment_12/experiment12_duplicate_suppression_policy_diagnostics.png)
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `Beam4Path` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 27.4010 | 6.8874 | 0.8321 | 0.5318 |
| `Beam4Path` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 22.5015 | 6.0689 | 0.0087 | 0.1779 |
| `Beam8Path` | `IndicesOnly` | 0.1395 | 0.0156 | 0.1983 | 0.6562 | 12.0049 | 11.2460 | 0.8364 | 0.5188 |
| `Beam8Path` | `PhaseAndResidualGain` | 0.0406 | 0.0087 | 0.0567 | 0.1970 | 17.5831 | 11.8806 | 0.0087 | 0.1772 |

### `construction_policy`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `AlternatingFinishRepair` | `IndicesOnly` | 0.1696 | 0.0087 | 0.2615 | 0.8333 | 12.9919 | 6.6810 | 0.9165 | 0.4654 |
| `AlternatingFinishRepair` | `PhaseAndResidualGain` | 0.0511 | 0.0087 | 0.0674 | 0.2530 | 19.5840 | 7.3052 | 0.0106 | 0.1664 |
| `BestOverallRepair` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 12.2199 | 5.7683 | 0.8321 | 0.5318 |
| `BestOverallRepair` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 17.7621 | 6.4351 | 0.0087 | 0.1779 |
| `CommonCaseRepair` | `IndicesOnly` | 0.0300 | 0.0243 | 0.1501 | 0.5000 | 14.0598 | 6.7463 | 0.5688 | 0.2599 |
| `CommonCaseRepair` | `PhaseAndResidualGain` | 0.0034 | 0.1651 | 0.1280 | 0.3891 | 19.5441 | 7.2809 | 0.0109 | 0.1297 |
| `FamilyBalancedRepair` | `IndicesOnly` | 0.1075 | 0.0150 | 0.1933 | 0.5984 | 13.0408 | 5.8906 | 0.7729 | 0.4346 |
| `FamilyBalancedRepair` | `PhaseAndResidualGain` | 0.0406 | 0.0044 | 0.0546 | 0.1684 | 18.2513 | 6.2020 | 0.0044 | 0.1701 |
| `FinishAndRepair` | `IndicesOnly` | 0.1696 | 0.0087 | 0.2747 | 1.0000 | 12.9944 | 5.7352 | 0.8813 | 0.4488 |
| `FinishAndRepair` | `PhaseAndResidualGain` | 0.0398 | 0.0087 | 0.0660 | 0.1994 | 18.1996 | 6.2228 | 0.0103 | 0.1712 |
| `FinishMoreLfos` | `IndicesOnly` | 0.3022 | 0.0044 | 0.4460 | 1.0000 | 13.1673 | 5.7439 | 1.0000 | 0.0000 |
| `FinishMoreLfos` | `PhaseAndResidualGain` | 0.2303 | 0.0044 | 0.4094 | 1.0000 | 18.5619 | 6.1920 | 1.0000 | 0.0000 |
| `FinishRepairRescue` | `IndicesOnly` | 0.0497 | 0.0081 | 0.1753 | 0.5980 | 13.8405 | 6.6473 | 0.6243 | 0.2902 |
| `FinishRepairRescue` | `PhaseAndResidualGain` | 0.0087 | 0.1277 | 0.0511 | 0.1500 | 19.1698 | 7.1602 | 0.0097 | 0.1405 |
| `HardCaseRepair` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2080 | 0.6667 | 13.6633 | 6.6916 | 0.8140 | 0.5344 |
| `HardCaseRepair` | `PhaseAndResidualGain` | 0.0451 | 0.0087 | 0.0606 | 0.1837 | 19.2506 | 8.5541 | 0.0087 | 0.1790 |
| `MetricBalancedRepair` | `IndicesOnly` | 0.1401 | 0.0150 | 0.2136 | 0.6667 | 13.9641 | 6.8416 | 0.8399 | 0.5142 |
| `MetricBalancedRepair` | `PhaseAndResidualGain` | 0.0446 | 0.0087 | 0.0611 | 0.1868 | 19.6579 | 7.1354 | 0.0087 | 0.1750 |
| `PathAwareRepair` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 12.0938 | 5.9215 | 0.8321 | 0.5318 |
| `PathAwareRepair` | `PhaseAndResidualGain` | 0.0414 | 0.0087 | 0.0581 | 0.1810 | 18.0874 | 6.2295 | 0.0087 | 0.1748 |
| `ShapeClusterRepair` | `IndicesOnly` | 0.1421 | 0.0150 | 0.2095 | 0.6630 | 14.4564 | 6.7292 | 0.8081 | 0.5347 |
| `ShapeClusterRepair` | `PhaseAndResidualGain` | 0.0395 | 0.0087 | 0.0582 | 0.1846 | 20.0846 | 7.2252 | 0.0087 | 0.1761 |
| `TuneAtomsAfterUse` | `IndicesOnly` | 0.1324 | 0.0056 | 0.1783 | 0.5756 | 19.7019 | 5.8626 | 0.8006 | 0.4125 |
| `TuneAtomsAfterUse` | `PhaseAndResidualGain` | 0.0165 | 0.0044 | 0.0899 | 0.3051 | 25.3123 | 6.3464 | 0.0044 | 0.1426 |

### `utility_candidate_budget`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `CandidateBudget12` | `IndicesOnly` | 0.1218 | 0.0143 | 0.2101 | 0.6659 | 11.6481 | 7.4297 | 0.7925 | 0.5756 |
| `CandidateBudget12` | `PhaseAndResidualGain` | 0.0402 | 0.0087 | 0.0624 | 0.1960 | 22.0455 | 8.3261 | 0.0087 | 0.1830 |
| `CandidateBudget24` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 17.3911 | 7.7125 | 0.8321 | 0.5318 |
| `CandidateBudget24` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 20.1140 | 6.7153 | 0.0087 | 0.1779 |
| `CandidateBudget48` | `IndicesOnly` | 0.1363 | 0.0187 | 0.2013 | 0.6190 | 14.1409 | 6.2079 | 0.8028 | 0.5354 |
| `CandidateBudget48` | `PhaseAndResidualGain` | 0.0390 | 0.0087 | 0.0561 | 0.1803 | 25.7701 | 6.6890 | 0.0087 | 0.1744 |
| `CandidateBudget8` | `IndicesOnly` | 0.1210 | 0.0187 | 0.2120 | 0.6667 | 11.6297 | 5.7086 | 0.8417 | 0.5839 |
| `CandidateBudget8` | `PhaseAndResidualGain` | 0.0484 | 0.0087 | 0.0619 | 0.2875 | 14.5487 | 6.1955 | 0.0087 | 0.1791 |

### `layer_normalization_policy`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `BoundedResidualStep` | `IndicesOnly` | 0.1515 | 0.0056 | 0.3009 | 1.0000 | 16.3438 | 7.8585 | 0.7449 | 0.0000 |
| `BoundedResidualStep` | `PhaseAndResidualGain` | 0.0429 | 0.0087 | 0.1303 | 0.5158 | 21.8500 | 7.9036 | 0.1128 | 0.0001 |
| `FinalClipOnly` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 13.6648 | 6.2006 | 0.8321 | 0.5318 |
| `FinalClipOnly` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 19.6227 | 6.7517 | 0.0087 | 0.1779 |
| `LayerCenterPreserveClip` | `IndicesOnly` | 0.1647 | 0.0093 | 0.2126 | 0.7652 | 15.8999 | 6.8167 | 0.9069 | 0.0000 |
| `LayerCenterPreserveClip` | `PhaseAndResidualGain` | 0.0390 | 0.0087 | 0.0510 | 0.1563 | 21.2112 | 7.7517 | 0.0087 | 0.0000 |
| `LayerClip0To1` | `IndicesOnly` | 0.1696 | 0.0093 | 0.2158 | 0.8263 | 13.5272 | 6.2558 | 0.8997 | 0.0000 |
| `LayerClip0To1` | `PhaseAndResidualGain` | 0.0401 | 0.0087 | 0.0509 | 0.1641 | 19.5482 | 6.9451 | 0.0087 | 0.0000 |
| `LayerClipNeg0p1To1p1` | `IndicesOnly` | 0.1696 | 0.0100 | 0.2087 | 0.7668 | 13.6399 | 6.1366 | 0.8922 | 0.4580 |
| `LayerClipNeg0p1To1p1` | `PhaseAndResidualGain` | 0.0408 | 0.0087 | 0.0545 | 0.1795 | 18.9346 | 6.7073 | 0.0087 | 0.1595 |
| `LayerClipNeg1To1` | `IndicesOnly` | 0.1696 | 0.0100 | 0.2154 | 0.8046 | 13.8189 | 6.1555 | 0.8891 | 0.1517 |
| `LayerClipNeg1To1` | `PhaseAndResidualGain` | 0.0383 | 0.0087 | 0.0582 | 0.2821 | 19.0457 | 6.8430 | 0.0087 | 0.0578 |
| `LayerSoftClip0To1` | `IndicesOnly` | 0.1828 | 0.0044 | 0.2626 | 0.9820 | 13.7608 | 6.8298 | 0.9651 | 0.0000 |
| `LayerSoftClip0To1` | `PhaseAndResidualGain` | 0.1187 | 0.0044 | 0.1978 | 0.7510 | 19.3392 | 8.1602 | 0.9717 | 0.0000 |
| `LayerSoftClipNeg0p1To1p1` | `IndicesOnly` | 0.1828 | 0.0087 | 0.2558 | 0.9362 | 16.5611 | 7.4728 | 0.9530 | 0.4766 |
| `LayerSoftClipNeg0p1To1p1` | `PhaseAndResidualGain` | 0.1188 | 0.0087 | 0.2199 | 0.7676 | 21.5257 | 8.2844 | 0.9782 | 0.3528 |
| `OvershootPenaltyNoClip` | `IndicesOnly` | 0.2029 | 0.0056 | 0.2993 | 1.0000 | 15.6429 | 7.7986 | 0.9822 | 0.0552 |
| `OvershootPenaltyNoClip` | `PhaseAndResidualGain` | 0.0445 | 0.0087 | 0.0638 | 0.1974 | 22.0703 | 8.4366 | 0.0044 | 0.1133 |

### `no_damage_policy`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `LateLayerNoDamage` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2059 | 0.6845 | 11.8241 | 6.6501 | 0.8368 | 0.5277 |
| `LateLayerNoDamage` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 27.3323 | 7.0330 | 0.0087 | 0.1779 |
| `LateLayerNoDamageAndPerfectLocking` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2059 | 0.6845 | 11.4345 | 6.1322 | 0.8368 | 0.5277 |
| `LateLayerNoDamageAndPerfectLocking` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 18.0694 | 6.9222 | 0.0087 | 0.1779 |
| `NoDamageOff` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 11.5192 | 6.3150 | 0.8321 | 0.5318 |
| `NoDamageOff` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 18.2375 | 6.9013 | 0.0087 | 0.1779 |
| `PerfectLocking` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 11.5147 | 6.1855 | 0.8321 | 0.5318 |
| `PerfectLocking` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 18.3230 | 6.7490 | 0.0087 | 0.1779 |

### `atom_preprocessing_policy`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `CenteredEnergyNormalizedAtoms` | `IndicesOnly` | 0.1737 | 0.0044 | 0.3003 | 0.9839 | 16.8027 | 6.5017 | 1.0000 | 0.2250 |
| `CenteredEnergyNormalizedAtoms` | `PhaseAndResidualGain` | 0.0402 | 0.0044 | 0.0677 | 0.2147 | 21.8282 | 7.1741 | 0.0056 | 0.1531 |
| `EnergyNormalizedAtoms` | `IndicesOnly` | 0.1541 | 0.0044 | 0.1919 | 0.6319 | 11.6017 | 6.0565 | 0.7022 | 0.4493 |
| `EnergyNormalizedAtoms` | `PhaseAndResidualGain` | 0.0389 | 0.0087 | 0.0590 | 0.1804 | 18.8382 | 8.7149 | 0.0087 | 0.1827 |
| `RawAtoms` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 11.2318 | 6.0370 | 0.8321 | 0.5318 |
| `RawAtoms` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 18.2910 | 6.9124 | 0.0087 | 0.1779 |

### `duplicate_suppression_policy`

| Value | ScalarSchema | Median RMSE | Perfect Rate | P95 RMSE | Node Max P95 | Construct s | Encode s | NoOp Median | Overshoot Rate |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `DuplicateSuppressionOff` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 11.7624 | 6.2696 | 0.8321 | 0.5318 |
| `DuplicateSuppressionOff` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 18.3394 | 7.1177 | 0.0087 | 0.1779 |
| `PhaseScaleDuplicateSuppression` | `IndicesOnly` | 0.1395 | 0.0112 | 0.2085 | 0.6795 | 19.5394 | 6.5678 | 0.8321 | 0.5318 |
| `PhaseScaleDuplicateSuppression` | `PhaseAndResidualGain` | 0.0409 | 0.0087 | 0.0580 | 0.1830 | 26.8901 | 7.1420 | 0.0087 | 0.1779 |
